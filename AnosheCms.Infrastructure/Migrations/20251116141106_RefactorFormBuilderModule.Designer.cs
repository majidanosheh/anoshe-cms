...
namespace AnosheCms.Infrastructure.Migrations
{
    ...
    [Migration("20251116141106_RefactorFormBuilderModule")]
    partial class RefactorFormBuilderModule
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AnosheCms.Domain.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 11, 16, 14, 11, 5, 805, DateTimeKind.Utc).AddTicks(5741),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 11, 16, 14, 11, 5, 805, DateTimeKind.Utc).AddTicks(5744),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 11, 16, 14, 11, 5, 805, DateTimeKind.Utc).AddTicks(5746),
            ...
            modelBuilder.Entity("AnosheCms.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "3d69374e-3a68-476c-b542-1ef722afcf4d",
                            CreatedDate = new DateTime(2025, 11, 16, 14, 11, 5, 805, DateTimeKind.Utc).AddTicks(5964),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEPxCrPOZP6eIzdshUxSVX7yUH+qelUtoY4xwF45syfgVRvsQFgdGwEgukUAGAtJhXA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "93b2ab8e-2495-4d3d-879d-9bd33902e872",
            ...
            modelBuilder.Entity("AnosheCms.Domain.Entities.ApplicationUserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AssignedAt = new DateTime(2025, 11, 16, 14, 11, 5, 872, DateTimeKind.Utc).AddTicks(6755)
                        },
                        new
                        {
                            UserId = new Guid("d1a1b1c1-1111-4444-8888-d1a1b1c1e1f1"),
                            RoleId = new Guid("a2b2c2d2-2222-4444-8888-a2b2c2d2e2f2"),
                            AssignedAt = new DateTime(2025, 11, 16, 14, 11, 5, 872, DateTimeKind.Utc).AddTicks(6757)
                        });
                });
