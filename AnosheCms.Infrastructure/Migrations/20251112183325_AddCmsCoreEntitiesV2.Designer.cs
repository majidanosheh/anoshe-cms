...
namespace AnosheCms.Infrastructure.Migrations
{
    ...
    [Migration("20251112183325_AddCmsCoreEntitiesV2")]
    partial class AddCmsCoreEntitiesV2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AnosheCms.Domain.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 11, 12, 18, 33, 24, 814, DateTimeKind.Utc).AddTicks(8274),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 11, 12, 18, 33, 24, 814, DateTimeKind.Utc).AddTicks(8276),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 11, 12, 18, 33, 24, 814, DateTimeKind.Utc).AddTicks(8278),
            ...
            modelBuilder.Entity("AnosheCms.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e2f0a2d3-f8e3-4e15-aa50-cb47949fe7c0",
                            CreatedDate = new DateTime(2025, 11, 12, 18, 33, 24, 814, DateTimeKind.Utc).AddTicks(8541),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEKQQLEJOvBrQRkMEQjHWNqPZMLQwkqqN0M/H4VikDx/dlSQA6+r0bzZLfXknFLF5uw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "e1bee927-23bf-4cd8-a7eb-2ba8b5930f1a",
            ...
            modelBuilder.Entity("AnosheCms.Domain.Entities.ApplicationUserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AssignedAt = new DateTime(2025, 11, 12, 18, 33, 24, 886, DateTimeKind.Utc).AddTicks(2235)
                        },
                        new
                        {
                            UserId = new Guid("d1a1b1c1-1111-4444-8888-d1a1b1c1e1f1"),
                            RoleId = new Guid("a2b2c2d2-2222-4444-8888-a2b2c2d2e2f2"),
                            AssignedAt = new DateTime(2025, 11, 12, 18, 33, 24, 886, DateTimeKind.Utc).AddTicks(2237)
                        });
                });
