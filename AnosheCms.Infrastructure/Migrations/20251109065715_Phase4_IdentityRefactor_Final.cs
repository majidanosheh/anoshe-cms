...
{
    /// <inheritdoc />
    public partial class Phase4_IdentityRefactor_Final : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a1b1c1d1-1111-4444-8888-a1b1c1d1e1f1"), null, null, new DateTime(2025, 11, 9, 6, 57, 14, 688, DateTimeKind.Utc).AddTicks(4347), null, null, "دسترسی کامل به تمام سیستم", "سوپر ادمین", false, true, null, null, "SuperAdmin", "SUPERADMIN" },
                    { new Guid("a2b2c2d2-2222-4444-8888-a2b2c2d2e2f2"), null, null, new DateTime(2025, 11, 9, 6, 57, 14, 688, DateTimeKind.Utc).AddTicks(4349), null, null, "دسترسی به بخش مدیریت محتوا و ساختار", "ادمین", false, true, null, null, "Admin", "ADMIN" },
                    { new Guid("a3b3c3d3-3333-4444-8888-a3b3c3d3e3f3"), null, null, new DateTime(2025, 11, 9, 6, 57, 14, 688, DateTimeKind.Utc).AddTicks(4351), null, null, "دسترسی پایه (در صورت نیاز)", "کاربر", false, true, null, null, "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("d1a1b1c1-1111-4444-8888-d1a1b1c1e1f1"), 0, "93f86288-8dc2-479d-97eb-2f5b17fd6e86", null, new DateTime(2025, 11, 9, 6, 57, 14, 688, DateTimeKind.Utc).AddTicks(4558), null, null, "admin@system.com", true, "System", true, false, null, null, null, "Administrator", null, false, null, "ADMIN@SYSTEM.COM", "ADMIN@SYSTEM.COM", "AQAAAAIAAYagAAAAEHP3HfKmnpd2ZeFH6saIopMqslM5icYWABSSKvnizmJvjwIkL34SlISPvFdsvwabHw==", null, false, null, "cd827655-7986-4fca-8c7d-0f955d2c0b0e", false, null, "admin@system.com" });

            migrationBuilder.InsertData(
                table: "UserRoles",
                columns: new[] { "RoleId", "UserId", "AssignedAt", "AssignedBy" },
                values: new object[] { new Guid("a1b1c1d1-1111-4444-8888-a1b1c1d1e1f1"), new Guid("d1a1b1c1-1111-4444-8888-d1a1b1c1e1f1"), new DateTime(2025, 11, 9, 6, 57, 14, 756, DateTimeKind.Utc).AddTicks(5562), null });
