...
namespace AnosheCms.Infrastructure.Migrations
{
    ...
    [Migration("20251201194728_AddOptionsToFormField")]
    partial class AddOptionsToFormField
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AnosheCms.Domain.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 12, 1, 19, 47, 28, 149, DateTimeKind.Utc).AddTicks(372),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 12, 1, 19, 47, 28, 149, DateTimeKind.Utc).AddTicks(375),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 12, 1, 19, 47, 28, 149, DateTimeKind.Utc).AddTicks(376),
            ...
            modelBuilder.Entity("AnosheCms.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "20f6914c-f3e8-4bc5-b98d-95b02aa1821a",
                            CreatedDate = new DateTime(2025, 12, 1, 19, 47, 28, 149, DateTimeKind.Utc).AddTicks(646),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEGTOMxHmQ3ACL0nb6eVECwcgcU2r0aM940sYKpqMhW4X8m6l1NJTGALwAVj7Lk3inA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "19bceaae-3a1c-491e-8791-db2b13a09981",
            ...
            modelBuilder.Entity("AnosheCms.Domain.Entities.ApplicationUserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AssignedAt = new DateTime(2025, 12, 1, 19, 47, 28, 215, DateTimeKind.Utc).AddTicks(2072)
                        },
                        new
                        {
                            UserId = new Guid("d1a1b1c1-1111-4444-8888-d1a1b1c1e1f1"),
                            RoleId = new Guid("a2b2c2d2-2222-4444-8888-a2b2c2d2e2f2"),
                            AssignedAt = new DateTime(2025, 12, 1, 19, 47, 28, 215, DateTimeKind.Utc).AddTicks(2074)
                        });
                });
