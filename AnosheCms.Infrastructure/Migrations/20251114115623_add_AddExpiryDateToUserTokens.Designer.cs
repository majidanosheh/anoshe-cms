...
namespace AnosheCms.Infrastructure.Migrations
{
    ...
    [Migration("20251114115623_add_AddExpiryDateToUserTokens")]
    partial class add_AddExpiryDateToUserTokens
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AnosheCms.Domain.Entities.ApplicationRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 11, 14, 11, 56, 23, 205, DateTimeKind.Utc).AddTicks(8927),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 11, 14, 11, 56, 23, 205, DateTimeKind.Utc).AddTicks(8929),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 11, 14, 11, 56, 23, 205, DateTimeKind.Utc).AddTicks(8930),
            ...
            modelBuilder.Entity("AnosheCms.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "2883b647-7200-418e-88f8-fab5e469472a",
                            CreatedDate = new DateTime(2025, 11, 14, 11, 56, 23, 205, DateTimeKind.Utc).AddTicks(9151),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJ0YIz8tufrKJP/HX/4eD+xeoyLayggeyjX8q5O8lE4Ua0JS4uPBA6eY/hethuZ5pw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "e7786244-1337-4e4a-aaa1-f6d3be8f4cf3",
            ...
            modelBuilder.Entity("AnosheCms.Domain.Entities.ApplicationUserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AssignedAt = new DateTime(2025, 11, 14, 11, 56, 23, 271, DateTimeKind.Utc).AddTicks(6235)
                        },
                        new
                        {
                            UserId = new Guid("d1a1b1c1-1111-4444-8888-d1a1b1c1e1f1"),
                            RoleId = new Guid("a2b2c2d2-2222-4444-8888-a2b2c2d2e2f2"),
                            AssignedAt = new DateTime(2025, 11, 14, 11, 56, 23, 271, DateTimeKind.Utc).AddTicks(6237)
                        });
                });
